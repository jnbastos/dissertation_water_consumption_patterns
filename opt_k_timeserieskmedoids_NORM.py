...
for i in [0,1,2,3,5]:
    ...
    # EUCLIDEAN
    ##########################
    savehere = 'results/NORM/Approach_1/TSKMedoids/'+agg_app_norm[i][0]+'/'+agg_app_norm[i][0]+'_eucl'
    ...
    savehere = 'results/NORM/Approach_1/TSKMedoids/'+agg_app_norm[i][0]+'/'+agg_app_norm[i][0]+'_dtw'
    ...
    savehere = 'results/NORM/Approach_1/TSKMedoids/'+agg_app_norm[i][0]+'/'+agg_app_norm[i][0]+'_dtw_sakoe_2'
    ...
    savehere = 'results/NORM/Approach_1/TSKMedoids/'+agg_app_norm[i][0]+'/'+agg_app_norm[i][0]+'_soft_dtw'
    """
    #%%
    print("\n\nSILHOUETTE Soft-DTW\n")
